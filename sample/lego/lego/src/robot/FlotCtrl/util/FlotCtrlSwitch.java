 ...
 * @generated
 */
public class FlotCtrlSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static FlotCtrlPackage modelPackage;
	 ...
	 * @generated
	 */
	public FlotCtrlSwitch() {
		if (modelPackage == null) {
			modelPackage = FlotCtrlPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FlotCtrlPackage.NEG_EXP: {
				NegExp negExp = (NegExp)theEObject;
				T result = caseNegExp(negExp);
				if (result == null) result = caseBoolExp(negExp);
				if (result == null) result = caseExpression(negExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlotCtrlPackage.BOOL_EXP: {
			...
			case FlotCtrlPackage.AND_EXP: {
				...
				if (result == null) result = caseBoolExp(andExp);
			...
			case FlotCtrlPackage.IF_BLOCK: {
				...
				if (result == null) result = caseExpression(ifBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Neg Exp</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Neg Exp</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNegExp(NegExp object) {
		return null;
	}
