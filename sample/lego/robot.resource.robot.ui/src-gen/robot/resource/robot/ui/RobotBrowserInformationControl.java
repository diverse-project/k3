...
public class RobotBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private robot.resource.robot.ui.RobotDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof robot.resource.robot.ui.RobotDocBrowserInformationControlInput);
		...
		fInput= (robot.resource.robot.ui.RobotDocBrowserInformationControlInput) input;
		...
		robot.resource.robot.ui.RobotHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = robot.resource.robot.ui.RobotHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public robot.resource.robot.ui.RobotDocBrowserInformationControlInput getInput() {
		return fInput;
	}
