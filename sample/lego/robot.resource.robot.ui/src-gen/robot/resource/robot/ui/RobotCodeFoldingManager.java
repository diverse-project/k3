...
public class RobotCodeFoldingManager {
	...
	private class FoldingUpdateListener implements robot.resource.robot.IRobotBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(robot.resource.robot.ui.RobotEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof robot.resource.robot.ui.RobotEditor) {
				robot.resource.robot.ui.RobotEditor editor = (robot.resource.robot.ui.RobotEditor) workbenchPart;
	...
	protected robot.resource.robot.ui.RobotEditor editor;
	 ...
	 */
	public RobotCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,robot.resource.robot.ui.RobotEditor textEditor) {
	...
	private void addCloseListener(final robot.resource.robot.ui.RobotEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			robot.resource.robot.ui.RobotUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		robot.resource.robot.IRobotTextResource textResource = (robot.resource.robot.IRobotTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
