...
public class RobotExpectedTerminal {
	...
	private robot.resource.robot.IRobotExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private robot.resource.robot.grammar.RobotContainmentTrace containmentTrace;
	
	public RobotExpectedTerminal(org.eclipse.emf.ecore.EObject container, robot.resource.robot.IRobotExpectedElement terminal, int followSetID, robot.resource.robot.grammar.RobotContainmentTrace containmentTrace) {
		super();
	...
	public robot.resource.robot.IRobotExpectedElement getTerminal() {
		return terminal;
	}
	...
	public robot.resource.robot.grammar.RobotContainmentTrace getContainmentTrace() {
