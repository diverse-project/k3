...
public abstract class RobotQuickFix implements robot.resource.robot.IRobotQuickFix {
	...
	public String apply(String currentText) {
		...
		try {
			...
			new robot.resource.robot.util.RobotRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
