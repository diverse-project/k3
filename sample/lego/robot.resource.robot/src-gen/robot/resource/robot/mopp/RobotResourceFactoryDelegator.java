...
public class RobotResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	protected void init() {
		...
		if (new robot.resource.robot.util.RobotRuntimeUtil().isEclipsePlatformAvailable()) {
			new robot.resource.robot.util.RobotEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new robot.resource.robot.mopp.RobotResourceFactory());
		}
	}
