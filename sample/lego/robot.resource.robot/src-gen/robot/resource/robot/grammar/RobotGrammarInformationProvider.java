...
public class RobotGrammarInformationProvider {
	...
	public final static robot.resource.robot.grammar.RobotContainment ROBOT_0_0_0_0 = new robot.resource.robot.grammar.RobotContainment(robot.FlotCtrl.FlotCtrlPackage.eINSTANCE.getProgramUnit().getEStructuralFeature(robot.FlotCtrl.FlotCtrlPackage.PROGRAM_UNIT__BLOCK), robot.resource.robot.grammar.RobotCardinality.STAR, new org.eclipse.emf.ecore.EClass[] {robot.FlotCtrl.FlotCtrlPackage.eINSTANCE.getExpression(), }, 0);
	...
	public final static robot.resource.robot.grammar.RobotRule ROBOT_0 = new robot.resource.robot.grammar.RobotRule(robot.FlotCtrl.FlotCtrlPackage.eINSTANCE.getProgramUnit(), ROBOT_0_0, robot.resource.robot.grammar.RobotCardinality.ONE);
