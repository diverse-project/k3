 ...
 */
public class RobotEnumerationTerminal extends robot.resource.robot.grammar.RobotTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public RobotEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, robot.resource.robot.grammar.RobotCardinality cardinality, int mandatoryOccurrencesAfter) {
