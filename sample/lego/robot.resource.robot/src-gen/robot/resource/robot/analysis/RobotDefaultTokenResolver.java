 ...
 */
public class RobotDefaultTokenResolver implements robot.resource.robot.IRobotTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, robot.resource.robot.IRobotTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : robot.resource.robot.grammar.RobotGrammarInformationProvider.INSTANCE.getKeywords()) {
