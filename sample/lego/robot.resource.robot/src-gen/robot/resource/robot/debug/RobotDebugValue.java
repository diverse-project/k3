...
public class RobotDebugValue extends robot.resource.robot.debug.RobotDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public RobotDebugValue(robot.resource.robot.debug.RobotDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
