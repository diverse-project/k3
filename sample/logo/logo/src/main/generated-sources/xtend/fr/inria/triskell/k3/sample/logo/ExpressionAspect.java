...
public class ExpressionAspect extends InstructionAspect {
  ...
  public static int eval(final Expression _self, final Context context) {
    fr.inria.triskell.k3.sample.logo.ExpressionAspectExpressionAspectContext _instance = fr.inria.triskell.k3.sample.logo.ExpressionAspectExpressionAspectContext.getInstance();
    						    java.util.Map<Expression,fr.inria.triskell.k3.sample.logo.ExpressionAspectExpressionAspectProperties> selfProp = _instance.getMap();
        						boolean _containsKey = selfProp.containsKey(_self);
    						    boolean _not = (!_containsKey);
    						    if (_not) {
          						fr.inria.triskell.k3.sample.logo.ExpressionAspectExpressionAspectProperties prop = new fr.inria.triskell.k3.sample.logo.ExpressionAspectExpressionAspectProperties();
  ...
  protected static int priveval(final Expression _self, final Context context) {
    return 0;
  }
}
