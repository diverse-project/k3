 ...
 */
public class ExpArithmtxtResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new expArithm.resource.expArithmtxt.util.ExpArithmtxtInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new expArithm.resource.expArithmtxt.util.ExpArithmtxtInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource getResource(java.io.File file) {
	...
	public static expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource) resource;
	}
	 ...
	 */
	public static expArithm.ExpressionArithm getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static expArithm.ExpressionArithm getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (expArithm.ExpressionArithm) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static expArithm.ExpressionArithm getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		expArithm.resource.expArithmtxt.IExpArithmtxtTextResource resource = (expArithm.resource.expArithmtxt.IExpArithmtxtTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (expArithm.resource.expArithmtxt.IExpArithmtxtTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		expArithm.resource.expArithmtxt.IExpArithmtxtTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
