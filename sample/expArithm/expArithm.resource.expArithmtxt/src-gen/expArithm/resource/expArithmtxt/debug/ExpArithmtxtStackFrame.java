...
public class ExpArithmtxtStackFrame extends expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget target;
	private String name;
	private int id;
	...
	public ExpArithmtxtStackFrame(expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = expArithm.resource.expArithmtxt.util.ExpArithmtxtStringUtil.decode(data, ',');
	...
	private expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		expArithm.resource.expArithmtxt.debug.ExpArithmtxtStackFrame other = (expArithm.resource.expArithmtxt.debug.ExpArithmtxtStackFrame) obj;
		if (name == null) {
