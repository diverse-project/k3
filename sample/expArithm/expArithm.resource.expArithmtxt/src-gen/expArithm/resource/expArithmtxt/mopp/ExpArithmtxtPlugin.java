 ...
 */
public class ExpArithmtxtPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "expArithm.resource.expArithmtxt";
	/**
	...
	private static ExpArithmtxtPlugin plugin;
	
	public ExpArithmtxtPlugin() {
		super();
	}
	...
	public static ExpArithmtxtPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, ExpArithmtxtPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, ExpArithmtxtPlugin.PLUGIN_ID, message);
		}
		final ExpArithmtxtPlugin pluginInstance = ExpArithmtxtPlugin.getDefault();
