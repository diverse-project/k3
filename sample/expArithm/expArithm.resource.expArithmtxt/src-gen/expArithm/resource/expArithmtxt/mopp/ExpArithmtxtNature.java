...
public class ExpArithmtxtNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "expArithm.resource.expArithmtxt.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {expArithm.resource.expArithmtxt.mopp.ExpArithmtxtBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(expArithm.resource.expArithmtxt.mopp.ExpArithmtxtBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
