...
/**
 * ExpArithmtxtLayoutInformation objects are used to store layout information that
 ...
 * ExpArithmtxtLayoutInformations are aggregated in LayoutInformationAdapters. One
 * ExpArithmtxtLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class ExpArithmtxtLayoutInformation {
	 ...
	 */
	private final expArithm.resource.expArithmtxt.grammar.ExpArithmtxtSyntaxElement syntaxElement;
	...
	public ExpArithmtxtLayoutInformation(expArithm.resource.expArithmtxt.grammar.ExpArithmtxtSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public expArithm.resource.expArithmtxt.grammar.ExpArithmtxtSyntaxElement getSyntaxElement() {
