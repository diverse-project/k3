 ...
 */
public class ExpArithmtxtCodeFoldingManager {
	
	private class FoldingUpdateListener implements expArithm.resource.expArithmtxt.IExpArithmtxtBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor) {
				expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor = (expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor) workbenchPart;
	...
	protected expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor;
	 ...
	 */
	public ExpArithmtxtCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor textEditor) {
	...
	private void addCloseListener(final expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		expArithm.resource.expArithmtxt.IExpArithmtxtTextResource textResource = (expArithm.resource.expArithmtxt.IExpArithmtxtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
