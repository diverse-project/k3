 ...
 */
public class ExpArithmtxtImageProvider {
	
	public final static ExpArithmtxtImageProvider INSTANCE = new ExpArithmtxtImageProvider();
	...
	public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
