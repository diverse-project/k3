...
public class ExpArithmtxtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private expArithm.resource.expArithmtxt.ui.ExpArithmtxtNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public ExpArithmtxtNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new expArithm.resource.expArithmtxt.ui.ExpArithmtxtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().getSyntaxName();
	}
