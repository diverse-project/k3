 ...
 * @since 3.2
 */
public class ExpArithmtxtBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput fInput;
	 ...
	 */
	public ExpArithmtxtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public ExpArithmtxtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public ExpArithmtxtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput);
		...
		fInput= (expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput) input;
		...
		expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput getInput() {
		return fInput;
	}
