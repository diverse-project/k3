...
public class K3SLESemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == K3slePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case K3slePackage.ASPECT_IMPORT:
				if(context == grammarAccess.getAspectImportRule()) {
					sequence_AspectImport(context, (AspectImport) semanticObject); 
					return; 
				}
				else break;
			case K3slePackage.ECORE_IMPORT:
				if(context == grammarAccess.getEcoreImportRule()) {
			...
			case K3slePackage.MEGAMODEL_ROOT:
				if(context == grammarAccess.getMegamodelRootRule()) {
					sequence_MegamodelRoot(context, (MegamodelRoot) semanticObject); 
					return; 
				}
				else break;
			...
			case K3slePackage.MODEL_TYPE:
				if(context == grammarAccess.getElementRule() ||
				   context == grammarAccess.getModelTypeRule()) {
					sequence_ModelType(context, (ModelType) semanticObject); 
					return; 
				}
				else break;
			case K3slePackage.PACKAGE_DECL:
				if(context == grammarAccess.getPackageDeclRule()) {
	 ...
	 */
	protected void sequence_AspectImport(EObject context, AspectImport semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, K3slePackage.Literals.ASPECT_IMPORT__ASPECT_REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, K3slePackage.Literals.ASPECT_IMPORT__ASPECT_REF));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getAspectImportAccess().getAspectRefJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getAspectRef());
		feeder.finish();
	}
	 ...
	 *     uri=STRING
	 */
	protected void sequence_EcoreImport(EObject context, EcoreImport semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, K3slePackage.Literals.ECORE_IMPORT__URI) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, K3slePackage.Literals.ECORE_IMPORT__URI));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getEcoreImportAccess().getUriSTRINGTerminalRuleCall_1_0(), semanticObject.getUri());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_MegamodelRoot(EObject context, MegamodelRoot semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=ValidID inheritanceRelation=Inheritance? ecore=EcoreImport? aspects+=AspectImport*)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ValidID extracted=[Metamodel|QualifiedName]? ecore=EcoreImport?)
	 */
	 ...
	 *     name=QualifiedName
	 */
	protected void sequence_PackageDecl(EObject context, PackageDecl semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, K3slePackage.Literals.PACKAGE_DECL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, K3slePackage.Literals.PACKAGE_DECL__NAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
