...
public class K3SLESyntacticSequencer extends AbstractSyntacticSequencer {

	protected K3SLEGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (K3SLEGrammarAccess) access;
