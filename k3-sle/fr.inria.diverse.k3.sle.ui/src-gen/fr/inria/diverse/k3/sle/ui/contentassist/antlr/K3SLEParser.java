...
* generated by Xtext
*/
package fr.inria.diverse.k3.sle.ui.contentassist.antlr;
...
public class K3SLEParser extends AbstractContentAssistParser {
	...
	@Override
	protected fr.inria.diverse.k3.sle.ui.contentassist.antlr.internal.InternalK3SLEParser createParser() {
		fr.inria.diverse.k3.sle.ui.contentassist.antlr.internal.InternalK3SLEParser result = new fr.inria.diverse.k3.sle.ui.contentassist.antlr.internal.InternalK3SLEParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMegamodelRootAccess().getGroup(), "rule__MegamodelRoot__Group__0");
					put(grammarAccess.getPackageDeclAccess().getGroup(), "rule__PackageDecl__Group__0");
					...
					put(grammarAccess.getModelTypeAccess().getGroup_2(), "rule__ModelType__Group_2__0");
					...
					put(grammarAccess.getTransformationAccess().getGroup_5_1(), "rule__Transformation__Group_5_1__0");
					put(grammarAccess.getEcoreImportAccess().getGroup(), "rule__EcoreImport__Group__0");
					put(grammarAccess.getAspectImportAccess().getGroup(), "rule__AspectImport__Group__0");
					...
					put(grammarAccess.getMegamodelRootAccess().getPackageAssignment_0(), "rule__MegamodelRoot__PackageAssignment_0");
					put(grammarAccess.getMegamodelRootAccess().getImportsAssignment_1(), "rule__MegamodelRoot__ImportsAssignment_1");
					put(grammarAccess.getMegamodelRootAccess().getElementsAssignment_2(), "rule__MegamodelRoot__ElementsAssignment_2");
					put(grammarAccess.getPackageDeclAccess().getNameAssignment_1(), "rule__PackageDecl__NameAssignment_1");
					put(grammarAccess.getMetamodelAccess().getNameAssignment_1(), "rule__Metamodel__NameAssignment_1");
					put(grammarAccess.getMetamodelAccess().getInheritanceRelationAssignment_2(), "rule__Metamodel__InheritanceRelationAssignment_2");
					put(grammarAccess.getMetamodelAccess().getEcoreAssignment_4(), "rule__Metamodel__EcoreAssignment_4");
					put(grammarAccess.getMetamodelAccess().getAspectsAssignment_5(), "rule__Metamodel__AspectsAssignment_5");
					put(grammarAccess.getInheritanceAccess().getSuperMetamodelAssignment_1(), "rule__Inheritance__SuperMetamodelAssignment_1");
					put(grammarAccess.getModelTypeAccess().getNameAssignment_1(), "rule__ModelType__NameAssignment_1");
					put(grammarAccess.getModelTypeAccess().getExtractedAssignment_2_1(), "rule__ModelType__ExtractedAssignment_2_1");
					put(grammarAccess.getModelTypeAccess().getEcoreAssignment_4(), "rule__ModelType__EcoreAssignment_4");
					put(grammarAccess.getTransformationAccess().getMainAssignment_0(), "rule__Transformation__MainAssignment_0");
					put(grammarAccess.getTransformationAccess().getReturnTypeRefAssignment_2(), "rule__Transformation__ReturnTypeRefAssignment_2");
					put(grammarAccess.getTransformationAccess().getNameAssignment_3(), "rule__Transformation__NameAssignment_3");
					put(grammarAccess.getTransformationAccess().getParametersAssignment_5_0(), "rule__Transformation__ParametersAssignment_5_0");
					put(grammarAccess.getTransformationAccess().getParametersAssignment_5_1_1(), "rule__Transformation__ParametersAssignment_5_1_1");
					put(grammarAccess.getTransformationAccess().getBodyAssignment_7(), "rule__Transformation__BodyAssignment_7");
					put(grammarAccess.getEcoreImportAccess().getUriAssignment_1(), "rule__EcoreImport__UriAssignment_1");
					put(grammarAccess.getAspectImportAccess().getAspectRefAssignment_1(), "rule__AspectImport__AspectRefAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			fr.inria.diverse.k3.sle.ui.contentassist.antlr.internal.InternalK3SLEParser typedParser = (fr.inria.diverse.k3.sle.ui.contentassist.antlr.internal.InternalK3SLEParser) parser;
			typedParser.entryRuleMegamodelRoot();
