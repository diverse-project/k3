 ...
 * <ul>
 *   <li>{@link fr.inria.diverse.k3.sle.metamodel.k3sle.impl.TransformationImpl#isMain <em>Main</em>}</li>
 ...
 * @generated
 */
public class TransformationImpl extends ElementImpl implements Transformation {
	/**
	...
	public void setMain(boolean newMain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, K3slePackage.TRANSFORMATION__MAIN, oldMain, main));
	}
	...
	public EList<JvmFormalParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<JvmFormalParameter>(JvmFormalParameter.class, this, K3slePackage.TRANSFORMATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain basicSetBody(XExpression newBody, NotificationChain msgs) {
		...
		body = newBody;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, K3slePackage.TRANSFORMATION__BODY, oldBody, newBody);
	...
	public void setBody(XExpression newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - K3slePackage.TRANSFORMATION__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - K3slePackage.TRANSFORMATION__BODY, null, msgs);
			msgs = basicSetBody(newBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, K3slePackage.TRANSFORMATION__BODY, newBody, newBody));
	}
	...
	public NotificationChain basicSetReturnTypeRef(JvmTypeReference newReturnTypeRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, K3slePackage.TRANSFORMATION__RETURN_TYPE_REF, oldReturnTypeRef, newReturnTypeRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReturnTypeRef(JvmTypeReference newReturnTypeRef) {
		if (newReturnTypeRef != returnTypeRef) {
			...
			if (returnTypeRef != null)
				msgs = ((InternalEObject)returnTypeRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - K3slePackage.TRANSFORMATION__RETURN_TYPE_REF, null, msgs);
			if (newReturnTypeRef != null)
				msgs = ((InternalEObject)newReturnTypeRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - K3slePackage.TRANSFORMATION__RETURN_TYPE_REF, null, msgs);
			msgs = basicSetReturnTypeRef(newReturnTypeRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, K3slePackage.TRANSFORMATION__RETURN_TYPE_REF, newReturnTypeRef, newReturnTypeRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case K3slePackage.TRANSFORMATION__PARAMETERS:
				return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
			case K3slePackage.TRANSFORMATION__BODY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case K3slePackage.TRANSFORMATION__MAIN:
				return isMain();
			case K3slePackage.TRANSFORMATION__PARAMETERS:
