...
public class GeometryAdapterFactory extends AdapterFactoryImpl {
	...
	protected GeometrySwitch<Adapter> modelSwitch =
		new GeometrySwitch<Adapter>() {
			...
			@Override
			public Adapter caseRegularGeometry(RegularGeometry object) {
				return createRegularGeometryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link geometry.RegularGeometry <em>Regular Geometry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRegularGeometryAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link geometry.Dimension <em>Dimension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
