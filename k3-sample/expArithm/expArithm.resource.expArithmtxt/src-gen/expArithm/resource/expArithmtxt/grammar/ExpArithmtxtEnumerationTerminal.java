 ...
 */
public class ExpArithmtxtEnumerationTerminal extends expArithm.resource.expArithmtxt.grammar.ExpArithmtxtTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public ExpArithmtxtEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, expArithm.resource.expArithmtxt.grammar.ExpArithmtxtCardinality cardinality, int mandatoryOccurrencesAfter) {
