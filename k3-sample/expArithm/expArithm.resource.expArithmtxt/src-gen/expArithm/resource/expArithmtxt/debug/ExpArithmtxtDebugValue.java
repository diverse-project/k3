...
public class ExpArithmtxtDebugValue extends expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public ExpArithmtxtDebugValue(expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
