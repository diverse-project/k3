...
public class ExpArithmtxtLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "expArithm.resource.expArithmtxt.debug.lineBreakpoint.marker";
	
	public ExpArithmtxtLineBreakpoint() {
		super();
	}
	
	public ExpArithmtxtLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget target) {
		try {
	...
	public void remove(expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
