 ...
 * instance of ExpArithmtxtDefaultTokenResolver which performs a standard
 * conversion based on the EMF type conversion. This includes conversion of
 * registered EDataTypes.
 * 
 * @see expArithm.resource.expArithmtxt.analysis.ExpArithmtxtDefaultTokenResolver
 */
public interface IExpArithmtxtTokenResolver extends expArithm.resource.expArithmtxt.IExpArithmtxtConfigurable {
