 ...
 */
public class ExpArithmtxtDefaultTokenResolver implements expArithm.resource.expArithmtxt.IExpArithmtxtTokenResolver {
	 ...
	 */
	public ExpArithmtxtDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public ExpArithmtxtDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, expArithm.resource.expArithmtxt.IExpArithmtxtTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : expArithm.resource.expArithmtxt.grammar.ExpArithmtxtGrammarInformationProvider.INSTANCE.getKeywords()) {
