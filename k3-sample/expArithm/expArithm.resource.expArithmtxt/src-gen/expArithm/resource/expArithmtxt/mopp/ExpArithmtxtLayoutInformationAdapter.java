...
/**
 * A ExpArithmtxtLayoutInformationAdapter is used to store layout information that
 ...
 * ExpArithmtxtLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class ExpArithmtxtLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<expArithm.resource.expArithmtxt.mopp.ExpArithmtxtLayoutInformation> layoutInformations = new java.util.ArrayList<expArithm.resource.expArithmtxt.mopp.ExpArithmtxtLayoutInformation>();
	...
	public java.util.List<expArithm.resource.expArithmtxt.mopp.ExpArithmtxtLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(expArithm.resource.expArithmtxt.mopp.ExpArithmtxtLayoutInformation layoutInformation) {
