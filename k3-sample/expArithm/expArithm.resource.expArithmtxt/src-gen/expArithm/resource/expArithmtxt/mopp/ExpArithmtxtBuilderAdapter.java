...
public class ExpArithmtxtBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "expArithm.resource.expArithmtxt.builder";
	
	private expArithm.resource.expArithmtxt.IExpArithmtxtBuilder defaultBuilder = new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		expArithm.resource.expArithmtxt.IExpArithmtxtBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource customResource = (expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource) resourceSet.getResource(uri, true);
			new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public expArithm.resource.expArithmtxt.IExpArithmtxtBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMarkerHelper().getMarkerID(expArithm.resource.expArithmtxt.ExpArithmtxtEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		expArithm.resource.expArithmtxt.mopp.ExpArithmtxtTaskItemBuilder taskItemBuilder = new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtTaskItemBuilder();
		new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().getSyntaxName())) {
