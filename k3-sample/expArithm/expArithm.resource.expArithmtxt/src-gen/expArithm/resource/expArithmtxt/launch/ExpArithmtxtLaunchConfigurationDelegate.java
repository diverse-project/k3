 ...
 */
public class ExpArithmtxtLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new expArithm.resource.expArithmtxt.launch.ExpArithmtxtLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
