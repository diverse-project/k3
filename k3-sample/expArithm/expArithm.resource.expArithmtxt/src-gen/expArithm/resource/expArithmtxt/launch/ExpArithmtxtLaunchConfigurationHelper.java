 ...
 * 
 */
package expArithm.resource.expArithmtxt.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class ExpArithmtxtLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends expArithm.resource.expArithmtxt.util.AbstractExpArithmtxtInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, expArithm.resource.expArithmtxt.util.AbstractExpArithmtxtInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebuggableInterpreter<ResultType, ContextType> interpreter = new expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebuggerListener<ResultType, ContextType> debugListener = new expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugProcess process = new expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugProcess(launch);
		launch.addDebugTarget(new expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(expArithm.resource.expArithmtxt.launch.ExpArithmtxtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return expArithm.resource.expArithmtxt.util.ExpArithmtxtResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, expArithm.resource.expArithmtxt.mopp.ExpArithmtxtPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
