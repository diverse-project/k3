 ...
 * to 4 bytes).
 */
public class ExpArithmtxtUnicodeConverter extends expArithm.resource.expArithmtxt.mopp.ExpArithmtxtInputStreamProcessor {
	 ...
	 */
	public ExpArithmtxtUnicodeConverter(java.io.InputStream inputStream) {
