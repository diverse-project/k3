 ...
 */
public class ExpArithmtxtRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			expArithm.resource.expArithmtxt.mopp.ExpArithmtxtPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			expArithm.resource.expArithmtxt.mopp.ExpArithmtxtPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
