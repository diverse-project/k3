 ...
 */
public class ExpArithmtxtStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, expArithm.resource.expArithmtxt.IExpArithmtxtFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, expArithm.resource.expArithmtxt.IExpArithmtxtFunction1<String, T> toStringFunction) {
