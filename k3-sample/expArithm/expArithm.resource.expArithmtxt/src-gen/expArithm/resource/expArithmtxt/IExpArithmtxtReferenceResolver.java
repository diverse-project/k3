 ...
 * resolver
 */
public interface IExpArithmtxtReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends expArithm.resource.expArithmtxt.IExpArithmtxtConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, expArithm.resource.expArithmtxt.IExpArithmtxtReferenceResolveResult<ReferenceType> result);
