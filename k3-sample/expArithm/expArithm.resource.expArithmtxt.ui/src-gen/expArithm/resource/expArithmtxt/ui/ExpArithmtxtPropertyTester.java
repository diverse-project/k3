...
public class ExpArithmtxtPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().getSyntaxName());
	}
