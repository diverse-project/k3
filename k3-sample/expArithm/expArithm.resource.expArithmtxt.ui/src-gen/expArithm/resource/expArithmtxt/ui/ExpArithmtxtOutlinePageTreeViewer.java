 ...
 * a specified depth.
 */
public class ExpArithmtxtOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public ExpArithmtxtOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = expArithm.resource.expArithmtxt.util.ExpArithmtxtStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof expArithm.resource.expArithmtxt.ui.ExpArithmtxtEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			expArithm.resource.expArithmtxt.mopp.ExpArithmtxtPlugin.logError("Exception while refreshing outline view", e);
		}
	}
