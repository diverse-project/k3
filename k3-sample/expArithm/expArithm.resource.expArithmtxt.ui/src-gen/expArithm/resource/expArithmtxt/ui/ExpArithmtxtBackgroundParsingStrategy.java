 ...
 */
public class ExpArithmtxtBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final expArithm.resource.expArithmtxt.IExpArithmtxtTextResource resource, final expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final expArithm.resource.expArithmtxt.IExpArithmtxtTextResource resource, final expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final expArithm.resource.expArithmtxt.IExpArithmtxtTextResource resource, final expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource) {
							expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource concreteResource = (expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource) resource;
