 ...
 */
public class ExpArithmtxtUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "expArithm.resource.expArithmtxt.ui";
	public static final String EDITOR_ID = "expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor";
	...
	private static ExpArithmtxtUIPlugin plugin;
	
	public ExpArithmtxtUIPlugin() {
		super();
	}
	...
	public static ExpArithmtxtUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ExpArithmtxtUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ExpArithmtxtUIPlugin.PLUGIN_ID, message);
		}
		final ExpArithmtxtUIPlugin pluginInstance = ExpArithmtxtUIPlugin.getDefault();
