 ...
 */
public class ExpArithmtxtNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public ExpArithmtxtNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new expArithmtxt file");
