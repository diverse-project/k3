...
public class ExpArithmtxtLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(expArithm.resource.expArithmtxt.mopp.ExpArithmtxtPlugin.DEBUG_MODEL_ID);
			...
			expArithm.resource.expArithmtxt.debug.ExpArithmtxtLineBreakpoint lineBreakpoint = new expArithm.resource.expArithmtxt.debug.ExpArithmtxtLineBreakpoint(resource, lineNumber + 1);
