 ...
 */
public class ExpArithmtxtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private expArithm.resource.expArithmtxt.IExpArithmtxtHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput infoInput = (expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					expArithm.resource.expArithmtxt.ui.ExpArithmtxtHyperlink hyperlink = new expArithm.resource.expArithmtxt.ui.ExpArithmtxtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl iControl = new expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput) {
							expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput input = (expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl.isAvailable(parent)) {
				expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl iControl = new expArithm.resource.expArithmtxt.ui.ExpArithmtxtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public ExpArithmtxtTextHover(expArithm.resource.expArithmtxt.IExpArithmtxtResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.insertPageProlog(buffer, 0, expArithm.resource.expArithmtxt.ui.ExpArithmtxtTextHover.getStyleSheet());
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.addPageEpilog(buffer);
			return new expArithm.resource.expArithmtxt.ui.ExpArithmtxtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = expArithm.resource.expArithmtxt.ui.ExpArithmtxtHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return expArithm.resource.expArithmtxt.util.ExpArithmtxtStreamUtil.getContent(styleSheetURL.openStream());
