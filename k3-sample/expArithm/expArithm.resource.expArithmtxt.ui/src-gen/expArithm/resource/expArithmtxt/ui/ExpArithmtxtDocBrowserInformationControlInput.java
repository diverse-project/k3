 ...
 * olInput</code>.
 */
public class ExpArithmtxtDocBrowserInformationControlInput {
	
	private final ExpArithmtxtDocBrowserInformationControlInput fPrevious;
	private ExpArithmtxtDocBrowserInformationControlInput fNext;
	 ...
	 */
	public ExpArithmtxtDocBrowserInformationControlInput(ExpArithmtxtDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public ExpArithmtxtDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public ExpArithmtxtDocBrowserInformationControlInput getNext() {
		return fNext;
	}
