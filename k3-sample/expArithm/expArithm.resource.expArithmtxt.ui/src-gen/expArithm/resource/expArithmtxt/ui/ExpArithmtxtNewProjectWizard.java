 ...
 */
public class ExpArithmtxtNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public ExpArithmtxtNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("expArithm.resource.expArithmtxt.ui");
							...
							String natureID = expArithm.resource.expArithmtxt.mopp.ExpArithmtxtNature.NATURE_ID;
							...
							for (String builderID : expArithm.resource.expArithmtxt.mopp.ExpArithmtxtNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation info = new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.getDefault().getBundle();
