...
public class ExpArithmtxtMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(expArithm.resource.expArithmtxt.IExpArithmtxtOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource) {
					expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource customResource = (expArithm.resource.expArithmtxt.mopp.ExpArithmtxtResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<expArithm.resource.expArithmtxt.IExpArithmtxtQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final expArithm.resource.expArithmtxt.IExpArithmtxtQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<expArithm.resource.expArithmtxt.IExpArithmtxtQuickFix> getQuickFixes(expArithm.resource.expArithmtxt.IExpArithmtxtTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					expArithm.resource.expArithmtxt.IExpArithmtxtQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
