 ...
 * 
 */
package expArithm.resource.expArithmtxt.ui.debug;

@SuppressWarnings("restriction")
public class ExpArithmtxtAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().getSyntaxName())) {
					return new expArithm.resource.expArithmtxt.ui.debug.ExpArithmtxtLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugVariable) {
			final expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugVariable variable = (expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugVariable) {
			final expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugVariable variable = (expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugValue castedValue = (expArithm.resource.expArithmtxt.debug.ExpArithmtxtDebugValue) value;
