 ...
 */
public class ExpArithmtxtCompletionProposal implements java.lang.Comparable<ExpArithmtxtCompletionProposal> {
	 ...
	 */
	private expArithm.resource.expArithmtxt.mopp.ExpArithmtxtExpectedTerminal expectedTerminal;
	...
	public ExpArithmtxtCompletionProposal(expArithm.resource.expArithmtxt.mopp.ExpArithmtxtExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public expArithm.resource.expArithmtxt.mopp.ExpArithmtxtExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof ExpArithmtxtCompletionProposal) {
			ExpArithmtxtCompletionProposal other = (ExpArithmtxtCompletionProposal) object;
	...
	public int compareTo(ExpArithmtxtCompletionProposal object) {
		if (object instanceof ExpArithmtxtCompletionProposal) {
			ExpArithmtxtCompletionProposal other = (ExpArithmtxtCompletionProposal) object;
