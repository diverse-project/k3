 ...
 */
public class ExpArithmtxtHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public ExpArithmtxtHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				expArithm.resource.expArithmtxt.mopp.ExpArithmtxtPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
