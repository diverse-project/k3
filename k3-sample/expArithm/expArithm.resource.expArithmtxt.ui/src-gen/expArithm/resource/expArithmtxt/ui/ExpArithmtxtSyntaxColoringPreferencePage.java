 ...
 */
public class ExpArithmtxtSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public ExpArithmtxtSyntaxColoringPreferencePage() {
		super();
		
		expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation metaInformation = new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, expArithm.resource.expArithmtxt.ui.ExpArithmtxtSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		expArithm.resource.expArithmtxt.ui.ExpArithmtxtPixelConverter pixelConverter = new expArithm.resource.expArithmtxt.ui.ExpArithmtxtPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor) {
			expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor emfTextEditor = (expArithm.resource.expArithmtxt.ui.ExpArithmtxtEditor) editor;
