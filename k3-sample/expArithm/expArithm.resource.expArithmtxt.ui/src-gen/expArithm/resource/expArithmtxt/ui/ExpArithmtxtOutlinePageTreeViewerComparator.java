...
public class ExpArithmtxtOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			expArithm.resource.expArithmtxt.IExpArithmtxtNameProvider nameProvider = new expArithm.resource.expArithmtxt.mopp.ExpArithmtxtMetaInformation().createNameProvider();
