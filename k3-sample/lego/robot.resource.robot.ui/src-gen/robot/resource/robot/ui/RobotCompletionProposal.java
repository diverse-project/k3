...
public class RobotCompletionProposal implements java.lang.Comparable<RobotCompletionProposal> {
	 ...
	 */
	private robot.resource.robot.mopp.RobotExpectedTerminal expectedTerminal;
	...
	public RobotCompletionProposal(robot.resource.robot.mopp.RobotExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public RobotCompletionProposal(robot.resource.robot.mopp.RobotExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public RobotCompletionProposal(robot.resource.robot.mopp.RobotExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public robot.resource.robot.mopp.RobotExpectedTerminal getExpectedTerminal() {
