...
public class RobotLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new robot.resource.robot.mopp.RobotMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(robot.resource.robot.launch.RobotLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			robot.resource.robot.mopp.RobotPlugin.logError("Exception while launching selection", e);
		}
	}
