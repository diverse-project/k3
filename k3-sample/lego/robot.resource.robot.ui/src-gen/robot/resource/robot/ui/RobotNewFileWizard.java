...
public class RobotNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private robot.resource.robot.ui.RobotNewFileWizardPage page;
	...
	public void addPages() {
		page = new robot.resource.robot.ui.RobotNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			robot.resource.robot.ui.RobotUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			robot.resource.robot.ui.RobotUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new robot.resource.robot.mopp.RobotMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new robot.resource.robot.mopp.RobotMetaInformation().getSyntaxName();
	}
