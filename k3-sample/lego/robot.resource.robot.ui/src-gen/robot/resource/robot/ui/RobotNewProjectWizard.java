...
public class RobotNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new robot.resource.robot.mopp.RobotMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("robot.resource.robot.ui");
							...
							String natureID = robot.resource.robot.mopp.RobotNature.NATURE_ID;
							...
							for (String builderID : robot.resource.robot.mopp.RobotNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								robot.resource.robot.mopp.RobotMetaInformation info = new robot.resource.robot.mopp.RobotMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = robot.resource.robot.ui.RobotUIPlugin.getDefault().getBundle();
