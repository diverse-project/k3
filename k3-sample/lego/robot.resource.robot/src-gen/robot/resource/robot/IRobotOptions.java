...
public interface IRobotOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new robot.resource.robot.mopp.RobotMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new robot.resource.robot.mopp.RobotMetaInformation().getResourcePostProcessorProviderOptionKey();
