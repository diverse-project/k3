...
public class RobotLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<robot.resource.robot.mopp.RobotLayoutInformation> layoutInformations = new java.util.ArrayList<robot.resource.robot.mopp.RobotLayoutInformation>();
	...
	public java.util.List<robot.resource.robot.mopp.RobotLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(robot.resource.robot.mopp.RobotLayoutInformation layoutInformation) {
