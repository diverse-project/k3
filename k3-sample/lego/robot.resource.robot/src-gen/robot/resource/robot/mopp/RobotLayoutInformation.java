...
public class RobotLayoutInformation {
	 ...
	 */
	private final robot.resource.robot.grammar.RobotSyntaxElement syntaxElement;
	...
	public RobotLayoutInformation(robot.resource.robot.grammar.RobotSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public robot.resource.robot.grammar.RobotSyntaxElement getSyntaxElement() {
