...
public class RobotResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new robot.resource.robot.util.RobotInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new robot.resource.robot.util.RobotInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static robot.resource.robot.mopp.RobotResource getResource(java.io.File file) {
	...
	public static robot.resource.robot.mopp.RobotResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new robot.resource.robot.mopp.RobotMetaInformation().registerResourceFactory();
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		robot.resource.robot.IRobotTextResource resource = (robot.resource.robot.IRobotTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (robot.resource.robot.IRobotTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		robot.resource.robot.IRobotTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
