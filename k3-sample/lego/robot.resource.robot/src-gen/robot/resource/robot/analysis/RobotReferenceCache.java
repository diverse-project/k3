 ...
 * given name.
 */
public class RobotReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements robot.resource.robot.IRobotReferenceCache {
	...
	private robot.resource.robot.IRobotNameProvider nameProvider;
	
	public RobotReferenceCache(robot.resource.robot.IRobotNameProvider nameProvider) {
		super();
