...
public class GeometrySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GeometryPackage.REGULAR_GEOMETRY: {
				RegularGeometry regularGeometry = (RegularGeometry)theEObject;
				T result = caseRegularGeometry(regularGeometry);
				if (result == null) result = caseGeometry(regularGeometry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeometryPackage.DIMENSION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Regular Geometry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Regular Geometry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRegularGeometry(RegularGeometry object) {
		return null;
	}
