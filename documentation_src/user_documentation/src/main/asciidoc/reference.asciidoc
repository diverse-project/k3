...
class PostAspect extends Parent1Aspect{ <3>
   def void someMethod(){
...
K3 uses the **@ReplaceAspectMethod** annotation to replace a method that is defined in the base class by a method in the aspect.
