...
/**
 * This is the item provider adapter for a {@link core.IntegerLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerLiteral_val_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerLiteral_val_feature", "_UI_IntegerLiteral_type"),
				 CorePackage.Literals.INTEGER_LITERAL__VAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_IntegerLiteral_type") + " " + integerLiteral.getVal();
	}
