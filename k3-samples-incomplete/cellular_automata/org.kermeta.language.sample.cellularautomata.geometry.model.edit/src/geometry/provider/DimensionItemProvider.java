...
/**
 * This is the item provider adapter for a {@link geometry.Dimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionItemProvider
	...
	/**
	 * This adds a property descriptor for the Is Circular feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsCircularPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_isCircular_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_isCircular_feature", "_UI_Dimension_type"),
				 GeometryPackage.Literals.DIMENSION__IS_CIRCULAR,
				 true,
				 false,
				 false,
